        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _KeypadIconButton(icon: FPhosphorIcons.backspace, onPress: onBackspacePressed),
            ],
          ),
        ],
      ),
...
class _KeypadButton extends StatelessWidget {
  const new({required this.text, required this.onPress});
  final String text;
  ...
  Widget build(BuildContext context) {
    return FTappable(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(shape: BoxShape.circle, color: context.theme.colors.secondary),
        child: Text(text, style: context.theme.typography.display.sm.copyWith(fontWeight: FontWeight.w400)),
      ),
    );
  }
}
...
class _KeypadIconButton extends StatelessWidget {
  const new({required this.onPress, this.icon, this.isLoading = false});
    ...
    return FTappable(
      ...
      child: Container(
        ...
        child: isLoading
            ...
            : Icon(icon ?? FPhosphorIcons.question, size: 28, color: context.theme.colors.primary),
      ),
    );
  }
}
