...
class AppConfig {
  ...
  static const bool seedEssentials = bool.fromEnvironment('POKA_SEED_ESSENTIALS', defaultValue: true);

  /// Whether to seed dummy data for testing purposes.
  ///
  /// Set via `POKA_SEED_DUMMY_DATA`. Defaults to `false`.
  static const bool seedDummyData = bool.fromEnvironment('POKA_SEED_DUMMY_DATA');
