...
class GoalDatePickerTile extends HookWidget {
  const GoalDatePickerTile({
    required this.date,
            ...
            child: IconTheme(
              ...
              child: date != null
                  ? GestureDetector(
                      ...
                      child: const Icon(FPhosphorIcons.x, size: 16),
                    )
                  : const Icon(FPhosphorIcons.caretDown, size: 16),
            ),
          ),
        );
      },
