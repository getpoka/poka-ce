...
mixin _$SettingsModel {
 ...
 String get themeMode; String get language; String get numberFormat; CurrencyModel? get baseCurrency;
...
int get hashCode {
  final _this = this as SettingsModel;
  return Object.hash(runtimeType,_this.themeMode,_this.language,_this.numberFormat,_this.baseCurrency);
}

@override
String toString() {
  final _this = this as SettingsModel;
  return 'SettingsModel(themeMode: ${_this.themeMode}, language: ${_this.language}, numberFormat: ${_this.numberFormat}, baseCurrency: ${_this.baseCurrency})';
}
...
@useResult
$Res call({
 String themeMode, String language, String numberFormat, CurrencyModel? baseCurrency
});


$CurrencyModelCopyWith<$Res>? get baseCurrency;
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? themeMode = null,Object? language = null,Object? numberFormat = null,Object? baseCurrency = freezed,}) {
...
@pragma('vm:prefer-inline')
$CurrencyModelCopyWith<$Res>? get baseCurrency {
    if (_self.baseCurrency == null) {
    return null;
  }

  return $CurrencyModelCopyWith<$Res>(_self.baseCurrency!, (value) {
    return _then(_self.copyWith(baseCurrency: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String themeMode,  String language,  String numberFormat,  CurrencyModel? baseCurrency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.themeMode,_that.language,_that.numberFormat,_that.baseCurrency);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String themeMode,  String language,  String numberFormat,  CurrencyModel? baseCurrency)  $default,) {final _that = this;
switch (_that) {
case _SettingsModel():
return $default(_that.themeMode,_that.language,_that.numberFormat,_that.baseCurrency);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String themeMode,  String language,  String numberFormat,  CurrencyModel? baseCurrency)?  $default,) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.themeMode,_that.language,_that.numberFormat,_that.baseCurrency);case _:
  return null;
...
class _SettingsModel implements SettingsModel {
  const _SettingsModel({required this.themeMode, this.language = 'system', this.numberFormat = 'system', this.baseCurrency});
...
@override@JsonKey() final  String numberFormat;
@override final  CurrencyModel? baseCurrency;
...
@override
int get hashCode {
    return Object.hash(runtimeType,themeMode,language,numberFormat,baseCurrency);
}

@override
String toString() {
    return 'SettingsModel(themeMode: $themeMode, language: $language, numberFormat: $numberFormat, baseCurrency: $baseCurrency)';
}
...
@override $CurrencyModelCopyWith<$Res>? get baseCurrency;
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? themeMode = null,Object? language = null,Object? numberFormat = null,Object? baseCurrency = freezed,}) {
