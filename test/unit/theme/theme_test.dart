...
void main() {
  ...
  group('Theme coverage', () {
    ...
    test('AppColors copyWith, lerp, equality', () {
      ...
      final b = a.copyWith(finance: _finance.copyWith(income: PokaColors.emerald500));
      expect(b.income, PokaColors.emerald500);
    ...
    test('PokaFinanceColors copyWith, lerp, equality', () {
      final b = _finance.copyWith(expense: PokaColors.rose400);
      expect(b.expense, PokaColors.rose400);
      expect(b.income, PokaColors.emerald700);
    ...
    test('PokaSurfaceColors copyWith, lerp, equality', () {
      final b = _surfaces.copyWith(raised: PokaColors.lightSunken);
      expect(b.raised, PokaColors.lightSunken);
      expect(b.canvas, PokaColors.white);
    ...
    test('dark base tones match the specified Better Stack palette', () {
      expect(darkColors.background, PokaColors.darkCanvas);
    ...
    test('FColors extensions', () {
      expect(lightColors.app.income, PokaColors.emerald700);
      expect(lightColors.app.finance.incomeFill, PokaColors.emerald600);
      expect(darkColors.app.income, PokaColors.emerald400);
      expect(lightColors.app.transfer, PokaColors.indigo600);
    ...
    test('AppColors copyWith keeps other fields', () {
      const a = AppColors(finance: _finance, surfaces: _surfaces);
      final b = a.copyWith(finance: _finance.copyWith(expense: PokaColors.rose400));
      expect(b.expense, PokaColors.rose400);
      expect(b.income, PokaColors.emerald700);
    });
  });
